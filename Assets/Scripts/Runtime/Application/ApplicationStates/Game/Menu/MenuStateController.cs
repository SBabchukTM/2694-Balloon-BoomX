...
namespace Runtime.Game
{
    public class MenuStateController : StateController
    {
        ...
        private void SubscribeToEvents()
        {
            ...
            _menuScreen.OnRulesPressed += async () => await _uiService.ShowPopup(ConstPopups.RulesPopup);
            _menuScreen.OnPrivacyPolicyPressed += async () => await _uiService.ShowPopup(ConstPopups.PrivacyPolicyPopup);
        }
    }
}